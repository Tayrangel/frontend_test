            ...
            <div class="md:col-span-2 bg-white border border-gray-300 rounded-md mb-5">
                ...
                <div class="mx-14 mt-10">
                    <div class="text-gray-500 font-bold" >Lorem Ipsum 
                        ...
                        <div class="flex text-gray-500 font-light mt-2">
                            <div class="w-1/2">
                                <svg class="h-4 w-4 text-gray-500 float-left mt-1"  fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="bg-white mt-2">
                            <nav class="flex flex-col sm:flex-row">
                                <button class="block font-medium text-green-700 border-b-2 hover:text-gray-300  hover:border-green-700 focus:outline-none px-6 py-4">Tweets</button>
                                <button class="block font-medium text-green-700 border-b-2 hover:text-gray-300  hover:border-green-700 focus:outline-none px-6 py-4">Replies</button>
                                <button class="block font-medium text-green-700 border-b-2 hover:text-gray-300  hover:border-green-700 focus:outline-none px-6 py-4">Midia</button>
                                <button class="block font-medium text-green-700 border-b-2 hover:text-gray-300  hover:border-green-700 focus:outline-none px-6 py-4">Links</button>
                            </nav>
                        </div>
                    </div>
                </div>
